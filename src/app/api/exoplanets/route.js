    ...
    try {
        ...
        const getExoplanetData = async (key) => {
            try {
                ...
                console.error('Error retrieving exoplanet data from Redis:', err);
                throw err;
            }
        };
        ...
        for (const key of keys) {
            ...
            if (x >= xMin && x <= xMax && y >= yMin && y <= yMax) {
                ...
                exoplanets.push({
                    ...
                    pl_masse: exoplanet.pl_masse ? parseFloat(exoplanet.pl_masse) : null,
                    pl_dens: exoplanet.pl_dens ? parseFloat(exoplanet.pl_dens) : null,
